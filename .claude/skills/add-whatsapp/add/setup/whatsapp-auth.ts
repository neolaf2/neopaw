...
<html><head><title>NeoPaw - WhatsApp Auth</title>
...
<html><head><title>NeoPaw - Connected!</title>
<style>
...
<script>localStorage.removeItem('neopaw_qr_start');</script>
</body></html>`;
