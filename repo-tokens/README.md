...
```yaml
- uses: qwibitai/neopaw/repo-tokens@v1
  with:
    include: 'src/**/*.ts'
    exclude: 'src/**/*.test.ts'
```
...
| Repo | Badge |
|------|-------|
| [NeoPaw](https://github.com/qwibitai/NeoPaw) | ![tokens](https://raw.githubusercontent.com/qwibitai/NeoPaw/main/repo-tokens/badge.svg) |
